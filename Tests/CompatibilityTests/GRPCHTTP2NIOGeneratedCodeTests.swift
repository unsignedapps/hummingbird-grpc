...
final class GRPCExpNIOGeneratedCodeTests: ServerTestCase {
    ...
    func testUnaryCall() async throws {
        ...
        let client = try await makeNIOGRPCClient(app: app, port: 9020, protocol: .grpcExp)
    ...
    func testServerStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9021, protocol: .grpcExp)
    ...
    func testClientStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9022, protocol: .grpcExp)
    ...
    func testBidirectionalStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9023, protocol: .grpcExp)
...
private extension GRPCExpNIOGeneratedCodeTests {
