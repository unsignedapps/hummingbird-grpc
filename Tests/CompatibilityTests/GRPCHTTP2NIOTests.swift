...
final class GRPCHTTP2NIOTests: ServerTestCase {
    ...
    func testUnaryCall() async throws {
        ...
        let client = try await makeNIOGRPCClient(app: app, port: 9030, protocol: .http2)
    ...
    func testServerStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9031, protocol: .http2)
    ...
    func testClientStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9032, protocol: .http2)
    ...
    func testBidirectionalStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeNIOGRPCClient(app: app, port: 9033, protocol: .http2)
...
private extension GRPCHTTP2NIOTests {
