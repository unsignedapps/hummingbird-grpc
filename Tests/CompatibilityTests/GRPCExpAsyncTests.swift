...
final class GRPCExpAsyncTests: ServerTestCase {
    ...
    func testUnaryCall() async throws {
        ...
        let client = try await makeAsyncGRPCClient(app: app, port: 9010, protocol: .grpcExp)
    ...
    func testServerStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeAsyncGRPCClient(app: app, port: 9011, protocol: .grpcExp)
    ...
    func testClientStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeAsyncGRPCClient(app: app, port: 9012, protocol: .grpcExp)
    ...
    func testBidirectionalStreamingCall() async throws {
        ...
        // AND GIVEN a grpc-swift client
        let client = try await makeAsyncGRPCClient(app: app, port: 9013, protocol: .grpcExp)
